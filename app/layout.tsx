...
export const metadata: Metadata = {
  ...
  title: {
    default: "Anna's Garden Hotel | Tbilisi, Georgia",
    template: "%s · Anna's Garden Hotel",
  },
  ...
  openGraph: {
    title: "Anna's Garden Hotel | Tbilisi, Georgia",
    description: "A quiet modern stay in Tbilisi with bright rooms, free Wi-Fi and free private parking.",
    type: "website",
    url: SITE_URL,
  ...
  twitter: {
    ...
    description: "A quiet modern stay in Tbilisi, Georgia.",
    images: [HERO],
  },
...
const hotelSchema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      name: "Anna's Garden Hotel",
      url: SITE_URL,
      image: `${SITE_URL}/media/hero-user.webp`,
      telephone: PHONE_DISPLAY,
      sameAs: [BOOKING_URL],
      address: {
        "@type": "PostalAddress",
        streetAddress: "10 Shalva Mshvelidze Street",
        postalCode: "0190",
      ...
      checkoutTime: "12:00",
      petsAllowed: false,
      amenityFeature: HOTEL_AMENITIES.map((name) => ({ "@type": "LocationFeatureSpecification", name, value: true })),
    },
  ],
};
    ...
    <html lang="en">
      <head>
        ...
        <style>{`
          ...
          .hero-photo { opacity: 0 !important; }
          @media (max-width: 700px) { .hero { background-position: 52% center !important; } }
        `}</style>
      </head>
      <body>
        {children}
        ...
        {GA_ID ? (
          <>
            ...
            <Script id="google-analytics" strategy="afterInteractive">{`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','${GA_ID}',{anonymize_ip:true});`}</Script>
          </>
        ) : null}
      </body>
    </html>
